...
const HeroSection = () => {
    return (
        <div className="max-w-7xl mx-auto flex xl:flex-row flex-col justify-center items-center py-10">
            ...
            <div className="w-full flex flex-col items-center justify-center gap-10 text-white lg:m-0 mt-10">
...
const SuggestionSection = () => {
    return (
        <div className="max-w-7xl mx-auto py-10 flex flex-col items-center gap-10 text-white">
            <div className="w-full p-10 flex flex-col lg:flex-row general-backgroundcolor justify-around rounded-xl items-center gap-5">
                ...
                <Image
                    ...
                    height={300}
                    alt="Chessboard"
                    className="rounded-lg shadow-lg w-full lg:w-[400px] h-auto"
                />
            </div>

            <div className="w-full p-10 flex flex-col-reverse lg:flex-row general-backgroundcolor justify-around rounded-xl items-center gap-5 ">
                <Image
                    src={'/assets/chinesechessboard.png'}
                    width={400}
                    height={300}
                    alt="Chessboard"
                    className="rounded-lg shadow-lg w-full lg:w-[400px] h-auto"
